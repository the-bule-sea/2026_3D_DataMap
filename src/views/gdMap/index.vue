<template>
  <div class="large-screen">
    ...
    <div class="large-screen-wrap" id="large-screen">
      <m-header title="上海市数据可视化平台" sub-text="Shanghai Economic Visualization Platform">
        <!-- 左侧 天气
      ...
      <div class="top-menu">
        <mMenu :default-active="state.activeIndex" @select="handleMenuSelect">
          <mMenuItem index="1">电力信息概览</mMenuItem>
  ...
  totalView: [
    {
      icon: "xiaoshoujine",
      zh: "2024年发电量",
      en: "Electricity Generation in 2024",
      value: 1085.04,
      unit: "亿千瓦时",
      decimals: 2,  // 显示2位小数
    },
    {
      icon: "zongxiaoliang",
      zh: "2024全口径供电可靠率",
      en: "Electricity Reliability Rate in 2024",
      value: 99.9937,
      unit: "%",
      decimals: 4,  // 显示4位小数
    },
...
onMounted(() => {
  ...
  initAssets(async () => {
    ...
    // 启动实时检测
    setTimeout(() => {
      mapSceneRef.value.canvasMap.startMonitoring(5000)
    }, 3000)
  })
})
onBeforeUnmount(() => {
